#ifndef UAL_GENERATION_PLATFORMS_SGX1_UNTRUSTED_GENERATOR_SGX_EPID_H_
#define UAL_GENERATION_PLATFORMS_SGX1_UNTRUSTED_GENERATOR_SGX_EPID_H_
...
// AttestationGeneratorSgxEpid for generating the attestation report for
// SGX EPID attestation mode enclave instance
class AttestationGeneratorSgxEpid : public AttestationGeneratorInterface {
 public:
 ...
 private:
  ...
  TeeErrorCode IasGetSigRL(const sgx_epid_group_id_t& gid, std::string* sigrl);
...
#endif  // UAL_GENERATION_PLATFORMS_SGX1_UNTRUSTED_GENERATOR_SGX_EPID_H_
