...
#define TEE_ERROR_RA_VERIFY_USER_DATA_SIZE                 TEE_MK_ERROR(0x1131)
#define TEE_ERROR_RA_VERIFY_PUBKEY_HASH_SIZE               TEE_MK_ERROR(0x1132)
#define TEE_ERROR_RA_VERIFY_SIG_INIT                       TEE_MK_ERROR(0x1133)
#define TEE_ERROR_RA_VERIFY_EMPTY_QUOTE_STATUS             TEE_MK_ERROR(0x1134)
#define TEE_ERROR_RA_VERIFY_ERROR_QUOTE_STATUS             TEE_MK_ERROR(0x1135)
#define TEE_ERROR_RA_VERIFY_NEED_RERERENCE_DATA            TEE_MK_ERROR(0x1136)
#define TEE_ERROR_RA_VERIFY_UNSUPPORT_REPORT_TYPE          TEE_MK_ERROR(0x1137)
#define TEE_ERROR_RA_VERIFY_UAS_QUOTE_BODY_EMPTY           TEE_MK_ERROR(0x1138)
#define TEE_ERROR_RA_VERIFY_UAS_RESULT_EMPTY               TEE_MK_ERROR(0x1139)
#define TEE_ERROR_RA_VERIFY_UAS_RESULT_CODE                TEE_MK_ERROR(0x113A)
#define TEE_ERROR_RA_VERIFY_UNEXPECTED_DEBUG_MODE          TEE_MK_ERROR(0x113B)
#define TEE_ERROR_RA_VERIFY_RULE_ENTRY_EMPTY               TEE_MK_ERROR(0x113C)
#define TEE_ERROR_RA_VERIFY_SMALLER_INFO_BUFFER            TEE_MK_ERROR(0x113D)
#define TEE_ERROR_RA_VERIFY_NOT_INITIALIZED                TEE_MK_ERROR(0x113E)

#define TEE_ERROR_RA_VERIFY_NESTED                         TEE_MK_ERROR(0x1140)
#define TEE_ERROR_RA_VERIFY_NESTED_GENERIC                 TEE_MK_ERROR(0x1141)
#define TEE_ERROR_RA_VERIFY_NESTED_ATTESTERS_SIZE          TEE_MK_ERROR(0x1142)
#define TEE_ERROR_RA_VERIFY_NESTED_POLICIES_SIZE           TEE_MK_ERROR(0x1143)
#define TEE_ERROR_RA_VERIFY_NESTED_ATTRIBUTES_SIZE         TEE_MK_ERROR(0x1144)
#define TEE_ERROR_RA_VERIFY_NESTED_REPORTS                 TEE_MK_ERROR(0x1146)
#define TEE_ERROR_RA_VERIFY_NESTED_REPORTS_SIGNATURE       TEE_MK_ERROR(0x1147)
#define TEE_ERROR_RA_VERIFY_NESTED_REPORTS_SMALLER_BUFFER  TEE_MK_ERROR(0x1148)
#define TEE_ERROR_RA_VERIFY_NESTED_REPORTS_SMALLER_BUFFER1 TEE_MK_ERROR(0x1149)
#define TEE_ERROR_RA_VERIFY_NESTED_GROUP_NAME              TEE_MK_ERROR(0x114A)
#define TEE_ERROR_RA_VERIFY_NESTED_GROUP_ID                TEE_MK_ERROR(0x114B)
